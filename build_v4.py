...
<head>
    ...
    <style>
        *,*::before,*::after{{margin:0;padding:0;box-sizing:border-box}}
        ...
        /* HERO SLIDER */
        .hero-slider{{position:relative;width:100%;overflow:hidden;background:#000;aspect-ratio:1920/650}}
        ...
        .p-img{{width:100%;aspect-ratio:1/1;overflow:hidden;background:var(--black4);display:flex;align-items:center;justify-content:center;padding:12px}}
        .p-img img{{width:100%;height:100%;object-fit:contain;transition:transform .5s ease}}
        ...
        /* STICKY BOTTOM BAR */
        .sticky-bar{{position:fixed;bottom:0;left:0;right:0;background:rgba(9,9,9,.95);backdrop-filter:blur(10px);border-top:1px solid var(--gold);display:none;grid-template-columns:1fr 1fr;padding:12px 16px;gap:12px;z-index:999}}
        .s-btn{{display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;border-radius:6px;font-size:.75rem;font-weight:700;text-transform:uppercase;text-decoration:none}}
        .s-wa{{background:#25D366;color:#fff}}
        .s-quote{{background:var(--gold);color:var(--black)}}
        ...
        @media(max-width:768px){{
            ...
            .hero-slider{{aspect-ratio:1920/650}}
...
<section class="hero-slider" id="heroSlider">
    <div class="slides" id="slides">
        <div class="slide"><img src="{I['hero1']}" alt="Purple Metal 9-Ball Table"></div>
        <div class="slide"><img src="{I['hero2']}" alt="OEM/ODM Pool Table Factory"></div>
...
<section class="sec blog-preview">
    ...
    <div style="max-width:1100px;margin:0 auto;display:grid;grid-template-columns:repeat(3,1fr);gap:30px">
        <a href="blog-slate-guide.html" style="background:var(--black2);border:1px solid rgba(201,169,110,.1);border-radius:12px;overflow:hidden;transition:var(--ease);display:block">
            <img src="https://sc04.alicdn.com/kf/H7a081b1e14b44148b934f387f26e60715/Good-Quality-Sundays-Billiard-Factory-Slate-Bed.jpg" alt="Professional slate guide" style="width:100%;height:180px;object-fit:cover">
            <div style="padding:20px"><div style="font-size:.65rem;color:var(--gold);margin-bottom:8px">TECHNICAL GUIDE</div><h4 style="font-family:var(--ff-h);font-size:1rem;line-height:1.4;margin-bottom:10px">How to Choose Professional Slate for Snooker Tables</h4><p style="font-size:.78rem;color:var(--gray)">Learn why thickness, CNC milling, and origin matter for tournament play...</p></div>
        </a>
        <a href="blog-importing-guide.html" style="background:var(--black2);border:1px solid rgba(201,169,110,.1);border-radius:12px;overflow:hidden;transition:var(--ease);display:block">
            <img src="https://sc02.alicdn.com/kf/Adc5adbd3a7534ad8a35b104ab0de65b6N.png" alt="Importing billiard tables guide" style="width:100%;height:180px;object-fit:cover">
            <div style="padding:20px"><div style="font-size:.65rem;color:var(--gold);margin-bottom:8px">LOGISTICS</div><h4 style="font-family:var(--ff-h);font-size:1rem;line-height:1.4;margin-bottom:10px">2026 Ultimate Guide for Importing Billiard Tables</h4><p style="font-size:.78rem;color:var(--gray)">HS Codes, shipping methods, and customs tips for global distributors...</p></div>
        </a>
        <a href="blog-factory-qc.html" style="background:var(--black2);border:1px solid rgba(201,169,110,.1);border-radius:12px;overflow:hidden;transition:var(--ease);display:block">
            <img src="https://sc02.alicdn.com/kf/A74832d556f3a41f18a32fc38e57263413.png" alt="Sundays Factory Quality Control" style="width:100%;height:180px;object-fit:cover">
            <div style="padding:20px"><div style="font-size:.65rem;color:var(--gold);margin-bottom:8px">INSIDE SUNDAYS</div><h4 style="font-family:var(--ff-h);font-size:1rem;line-height:1.4;margin-bottom:10px">The Gold Standard: Sundays' 12-Step QC Process</h4><p style="font-size:.78rem;color:var(--gray)">How we maintain zero-defect standards for our 8,000m² factory exports...</p></div>
        </a>
    </div>
...
<section class="faq-section">
    <div class="sec-head">
        <div class="sec-tag">GEO &amp; AI Knowledge</div>
        <h2 class="sec-title">Billiard Table <span style="color:var(--gold)">Expert FAQ</span></h2>
        <p class="sec-desc">B2B Sourcing Guide for Wholesalers and Club Owners.</p>
    </div>
    <div class="faq-wrap">
        <div class="faq-item">
            <div class="faq-q" onclick="toggleFaq(this)">Why choose a billiard table manufacturer from Guangzhou, China?<span class="faq-icon">+</span></div>
            <div class="faq-a"><p>Guangzhou is the global hub for high-end billiard manufacturing. Sundays Billiard provides factory-direct access to championship-grade slate and solid hardwood tables, offering significant cost savings for international B2B buyers compared to local resellers.</p></div>
        </div>
        <div class="faq-item">
            <div class="faq-q" onclick="toggleFaq(this)">How do you ensure the flatness of the pool table slate?<span class="faq-icon">+</span></div>
            <div class="faq-a"><p>We use CNC high-precision grinding machines to process our natural slate beds. Our flatness tolerance is less than 0.1mm, ensuring a perfectly level playing surface that meets professional tournament standards.</p></div>
        </div>
        <div class="faq-item">
            <div class="faq-q" onclick="toggleFaq(this)">What is the process for a custom OEM billiard table project?<span class="faq-icon">+</span></div>
            <div class="faq-a"><p>Our OEM process includes design consultation, 3D mockup creation, material selection (Ash, Oak, or Mahogany), and custom branding (logo engraving). We provide weekly production updates and strict QC before shipment to 50+ countries.</p></div>
        </div>
        <div class="faq-item">
            <div class="faq-q" onclick="toggleFaq(this)">How long does sea freight take from China to USA/Europe/Honduras?<span class="faq-icon">+</span></div>
            <div class="faq-a"><p>Shipping times vary: 3-4 weeks to the Middle East, 4-5 weeks to Europe and the USA West Coast, and 6-7 weeks to Central America (Honduras). We handle all export documentation and reinforced crating for safe delivery.</p></div>
        </div>
        <div class="faq-item">
...
<div class="sticky-bar">
    <a href="https://wa.me/8618824156040" target="_blank" class="s-btn s-wa"><i class="fab fa-whatsapp"></i> WhatsApp</a>
    <a href="#contact" class="s-btn s-quote"><i class="fas fa-paper-plane"></i> Get Quote</a>
</div>
...
// HERO SLIDER
var slideIdx=0, slideCount=4, autoSlide;
